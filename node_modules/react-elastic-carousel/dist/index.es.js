  ...
  function Carousel() {
    ...
    _defineProperty(_assertThisInitialized(_this), "onSwiping", function (data) {
      ...
      _this.setState(function (state) {
        ...
        var isHorizontalSwipe = dir === "Left" || dir === "Right";
        var shouldHorizontalSkipUpdate = isHorizontalSwipe && !verticalMode && absX > distanceSwipe;
        var shouldVerticalSkipUpdate = !isHorizontalSwipe && verticalMode && absY > distanceSwipe;
        ...
        return {
          swipedSliderPosition: isHorizontalSwipe ? sliderPosition - deltaX : sliderPosition - deltaY,
          isSwiping: true,
          transitioning: true
        };
      });
    ...
    _defineProperty(_assertThisInitialized(_this), "onSwiped", function (data) {
      ...
      var minSwipeDistance = childWidth / 3;
      var swipedLeft = dir === "Left";
      var swipedRight = dir === "Right";
      var swipedUp = dir === "Up";
      var swipedDown = dir === "Down";
      var verticalGoSwipe = verticalMode && (swipedUp || swipedDown) && absY > minSwipeDistance;
      var horizontalGoSwipe = !verticalMode && (swipedRight || swipedLeft) && absX > minSwipeDistance;
      var goodToGo = false;
  ...
  _createClass(Carousel, [{
    ...
    value: function render() {
      ...
      var _this$getDerivedProps11 = this.getDerivedPropsFromBreakPoint(),
          ...
          transitionMs = _this$getDerivedProps11.transitionMs,
